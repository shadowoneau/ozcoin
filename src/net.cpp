...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "OZcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"ldjcs.com.au", "brian.ldjcs.com.au"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"ozcointools.com", "testnet-seed.ozcointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. OZcoin is probably already running."), addrBind.ToString().c_str());
        else
